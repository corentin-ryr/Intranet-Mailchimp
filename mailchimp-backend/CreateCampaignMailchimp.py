...
apiKey = "API_KEY"
server = "SERVER"
subscriberListID = "ID" #id de la list Candidature


def createCampaignAndSendTestEmail(contentTitle, contentFirstDescription, contentDomain, imageDomain, contentPay, imagePay, contentDifficulty, imageDifficulty, contentSkills, contentSchedule, contentDescription, formBoolean, formLink, contactList):

	#Campaign Settings
	campaignName = contentTitle
	mailObject = "[Telecom Etude] " + contentTitle
	mailFromName = "Telecom Etude"
	mailReplyTo = contactList[0]
	testEmails = ["responsable.commercial@telecom-etude.fr"]
	...
	if imageDomain=="data" :
		imageDomaineLink = "https://mcusercontent.com/d64b9431d63c83512b8b612ee/images/3f084638-6053-45c6-a99e-7ad481f340fc.png"
	elif imageDomain=="dev" :
		imageDomaineLink = "https://mcusercontent.com/d64b9431d63c83512b8b612ee/images/458e3a19-7fe7-4471-aad4-8d19e43f2383.png"
	elif imageDomain=="cyber" :
		imageDomaineLink = "https://mcusercontent.com/d64b9431d63c83512b8b612ee/images/4d65cc38-f99c-4eb5-bd8b-f4c58d44aecb.png"
	elif imageDomain=="se" :
		imageDomaineLink = "https://mcusercontent.com/d64b9431d63c83512b8b612ee/images/ad81493a-5281-4772-adef-4bcebee00243.png"
	elif imageDomain=="image" :
		imageDomaineLink = "https://mcusercontent.com/d64b9431d63c83512b8b612ee/images/863635c4-6fc0-42d0-add6-7c4b8aa04b9b.png"
	elif imageDomain=="etude" :
		imageDomaineLink = "https://mcusercontent.com/d64b9431d63c83512b8b612ee/images/0104e278-2e89-44d0-823f-86e2e92a1e70.png"
	else:
		print("ERROR: the domain name is incorrect")

	if imagePay=="low":
		imagePayLink = "https://mcusercontent.com/d64b9431d63c83512b8b612ee/images/aa0aa2c2-9aaf-46f8-ae91-8c28953b02bc.png"
	elif imagePay=="middle":
	...
	for i in range(len(contactList)):
		mail = contactList[i]
		name = mail[0].capitalize() + mail[1:mail.find(".")]
		if(len(contactList)==1):
			contentMailContact += name + " (" + mail + ")."
		elif(i!=len(contactList)-1):
			contentMailContact += name + " (" + mail + "), "
		else:
	...
	<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="33%">
		<tbody><tr>
			<td class="mcnCaptionBottomImageContent" align="center" valign="top" style="padding:0 9px 9px 9px;">
				...
				<img alt="Domaine" src=\""""+imageDomaineLink+"""\" width="100%" style="max-width: 250px; border-top-left-radius: 0%; border-top-right-radius: 0%; border-bottom-right-radius: 0%; border-bottom-left-radius: 0%;" class="mcnImage">
	...
	try:
		...
		print("New campaign created with ID: ", campaignID)
	...
	try:
		...
		response = client.campaigns.set_content(campaignID, {"html": htmlContent})
		print("Content set")
	...
	try:
		...
		response = client.campaigns.send_test_email(campaignID, {"test_emails": testEmails, "send_type": "html"})
...
## Example
contentTitle = "Nom de l'étude"
contentFirstDescription = "Nous vous proposons aujourd’hui une étude de Data Science."
contentDomain = "Systèmes Embarqués"
imageDomain = "se" # parmi "data", "dev", "cyber", "se", "image", "etude"
contentPay = "1500-2000€"
imagePay = "middle" # parmi "low", "middle", "high"
contentDifficulty = "Difficile"
imageDifficulty = "high" # parmi "low", "middle", "high"
contentSkills = "Nous recherchons un.e ou plusieurs intervenant.e.s connaissant la Data Science."
contentSchedule = "Le client désire commencer le plus tôt possible."
contentDescription = "Le but de l'étude est de la finir."
formBoolean = True # True ou False selon si on joint un formualaire de candidature ou non
formLink = "https://docs.google.com/forms/d/e/1FAIpQLSduG7os1IrYWhV_BDVNz8CA-NSQDPAnBZrZVvXTzyeOshDSwQ/" # uniquement si formBoolean==True
contactList = ["hugo.queinnec@telecom-etude.fr", "corentin.royer@telecom-etude.fr"] # pas de limite de nombre d'adresses mail, mettre sous la forme prenom.nom@...
